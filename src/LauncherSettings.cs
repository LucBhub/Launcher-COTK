...
internal static class LauncherSettings
{
    ...
    public static void Load()
    {
        try
        {
            ...
            // Trim du BOM : un fichier ecrit par PowerShell (UTF8+BOM) ne doit
            // pas faire echouer le chargement en silence.
            var text = File.ReadAllText(SettingsPath).TrimStart('\uFEFF').Trim();
