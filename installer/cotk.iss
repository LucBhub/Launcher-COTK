...
[Files]
; Toute la sortie publish self-contained (runtime .NET embarque inclus),
; avec les sous-dossiers : sans eux le launcher croit etre framework-dependent
; et Windows propose de telecharger le .NET Desktop Runtime.
